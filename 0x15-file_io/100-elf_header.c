 ...
 * Description: If the file is not an ELF file - terminate code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
 ...
 *  @e_ident: This is a pointer to an array which contains the ELF version.
*/
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
 ...
 * Description: If the file cannot be closed terminate code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
...
/**
 * main - Displays the information which is in the ELF header at
 * the begining of an ELF file.
 * @argc: the no. of arguments supplied to the program.
 * @argv: This is an array of pointers to the arguments.
 * Return: return 0 on success.
 * Description: If the file isn't an ELF File or the function fails
 *              terminate code 98.
 */
